...
//               onChange={(e) => setSelectedPackage(e.target.value)}
//             >
//               {packages.map((pkg, i) => <option key={i}>{pkg}</option>)}
//             </select>
//           </div>
...
//   // Filter interviews based on user selection
//   const filteredInterviews = interviews.filter((i) => {
//     const roleMatch = selectedRole === "All Roles" || i.role === selectedRole;
//     const packageMatch = selectedPackage === "All" || i.stipend === selectedPackage;
...
//           <button className="add-btn" onClick={() => navigate("/add-interview")}>
//             + Add Interview
//           </button>
//         </div>

//         {/* Horizontal Interview Cards */}
